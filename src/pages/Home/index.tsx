		...
		<div className="mb-5">
			...
			<div className="row">
				<div style={{ 'width': '690px' }} className="col">
					<div className="text-center">
						<h4>PsyGift uses the power of the Everscale, Serum, Wormhole, Sollet, PsyOption, and Terra infrastructure to create the most easy, transparent, fun and digital charity auction on the web!</h4>
					</div>
				</div>
			</div>
			<div className="row">
