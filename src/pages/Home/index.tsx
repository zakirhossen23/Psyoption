		...
		<div className="mb-5">
			...
			<div className="row">
				<div style={{ 'width': '690px'}} className="col">
					<div className="text-center">
						<h4 style={{ fontSize: '20px'}}>PsyGift uses the power of the Solana infrastructure to create the most easy, transparent, fun and digital charity auction on the web!</h4>
					</div>
				</div>
			</div>
			<div className="row">
